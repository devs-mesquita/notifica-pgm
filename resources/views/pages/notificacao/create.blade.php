                                        ...
                                        <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <input onblur="validarCPF(this)" type="email" id="email" name="email[]"  class="form-control" placeholder="Email"  required >	
                                                </div>
                                                ...
                                                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <input type="text" id="codigo_verificador" name="codigo_verificador[]" placeholder="Codigo Verificador" maxlength="14" class="form-control">
                                                </div>
                                                <div class="form-group col-md-3 col-sm-3 col-xs-12">
                                                    <label class="control-label" for="n_acordo">Nº Acordo</label>
                                                    <input type="text" id="n_acordo" name="n_acordo[]" placeholder="Numero do Acordo" maxlength="14" class="form-control">
                                                </div>
                                                </div>
                                            </div>
                                        </li>
